...
public class PercolationStats_Weighted {
    ...
    // 在 n x n 网格上执行独立实验
    public PercolationStats_Weighted(int n, int trials) {
        if (n <= 0 || trials <= 0) {
    ...
    public static void main(String[] args) {
        ...
        PercolationStats_Weighted statistics = new PercolationStats_Weighted(n, trials);
